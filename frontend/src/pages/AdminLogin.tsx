    ...
    return (
        <div style={styles.wrapper as any}>
            <div style={styles.card as any}>
                ...
                <h1 style={styles.title as any}>Admin Login</h1>
                <p style={styles.subtitle as any}>Enter your credentials to manage the platform</p>
                ...
                <div style={styles.inputGroup as any}>
                    <div>
                        <input
                            style={{
                                ...styles.input,
                                borderColor: usernameError ? '#ef4444' : '#cbd5e1'
                            } as any}
                            name="username"
                    ...
                    <div>
                        <input
                            style={{
                                ...styles.input,
                                borderColor: passwordError ? '#ef4444' : '#cbd5e1'
                            } as any}
                            name="password"
